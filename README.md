...
**급할 때 쓰는 우회**: RPD는 **모델마다 따로** 셉니다. gpt-4o-mini가 막혀도 다른 모델은
살아 있으므로, Railway 환경변수만 바꾸면 즉시 다시 돕니다. 코드 수정은 필요 없습니다.

```
OPENAI_MISSION_MODEL=gpt-4.1-mini
